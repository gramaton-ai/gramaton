...
// serviceInspect returns a record with its properties, metadata summary,
// and related edges. Records access and spread activation. When
// includeContent is false, content_full is omitted from the response
